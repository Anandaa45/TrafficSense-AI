...
const translations = {
  id: {
    ...
    dashboardPage: {
      ...
      dominantStatus: 'Status Dominan',
      latestAnalysis: 'Analisis Terakhir',
      latestAnalysisSub: 'Ringkasan dari media terakhir yang dianalisis.',
      noAnalysis: 'Belum ada data analisis.',
      file: 'File',
      analysisTime: 'Waktu Analisis',
      status: 'Status',
      statusDistributionSub: 'Berdasarkan seluruh riwayat analisis.',
      vehicleStatistics: 'Statistik Jenis Kendaraan',
      vehicleStatisticsSub: 'Total kendaraan berdasarkan seluruh hasil analisis.',
      recentActivity: 'Aktivitas Terakhir',
      recentActivitySub: 'Lima hasil analisis terbaru.',
      noActivity: 'Belum ada aktivitas analisis.',
      car: 'Mobil',
      motor: 'Motor',
      bus: 'Bus',
      truck: 'Truk',
  ...
  en: {
    ...
    dashboardPage: {
      ...
      latestAnalysisSub: 'Summary from the latest analyzed media.',
      noAnalysis: 'No analysis data yet.',
      file: 'File',
      analysisTime: 'Analysis Time',
      status: 'Status',
      statusDistributionSub: 'Based on all analysis history.',
      vehicleStatistics: 'Vehicle Type Statistics',
      vehicleStatisticsSub: 'Total vehicles based on all analysis results.',
      recentActivity: 'Recent Activity',
      recentActivitySub: 'Five latest analysis results.',
      noActivity: 'No analysis activity yet.',
      car: 'Car',
      motor: 'Motorcycle',
      bus: 'Bus',
      truck: 'Truck',
    ...
    analyticsPage: {
      ...
      photo: 'Photo',
      video: 'Video',
      noHistory: 'No analysis history yet. Upload media from Traffic Monitor.',
      detailTitle: 'Analysis Details',
      totalVehicles: 'Total Vehicles',
      ...
      truck: 'Truck',
      close: 'Close',
      previewUnavailable: 'Preview file unavailable. Please re-analyze the media from Traffic Monitor.',
    },
  },
};
